...
export default {
  ...
  data() {
    ...
    return {
      ...
      roles: ['admin', 'auxiliar administrativo', 'director general', 'planeador de produccion', 'supervisor de produccion', 'gerente'],
      nonAdminRoles: ['auxiliar administrativo', 'director general', 'planeador de produccion', 'supervisor de produccion', 'gerente'],
      newUser: {},
