...
export default {
  ...
  data() {
    ...
    return {
      ...
      roles: ['admin', 'auxiliar administrativo', 'director general', 'planeador de produccion', 'supervisor de produccion', 'gerente','consulta externa timsa'],
      nonAdminRoles: ['auxiliar administrativo', 'director general', 'planeador de produccion', 'supervisor de produccion', 'gerente','consulta externa timsa'],
      newUser: {},
