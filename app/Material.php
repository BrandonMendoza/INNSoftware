...
class Material extends Model
{
    ...
    protected $fillable = ['id','numero_parte','peso_kg','tipo_material_id','acero_id','medida_1','medida_2','medida_3','medida_4','catalogo','medidas'];
    ...
    public function loadNombreCompleto(){   
        ...
        $this['nombreCompleto'] = $nombreMedidas;
    }

    public function loadAcero(){
        if($this->catalogo == 1){
            $nombreAcero = $this->Acero->nombre;
        }else{
            $nombreAcero = $this->Acero->nombre;
        }
    ...
    /** Funcion para obtener las medidas de un material con formato: '##x##x##' */
